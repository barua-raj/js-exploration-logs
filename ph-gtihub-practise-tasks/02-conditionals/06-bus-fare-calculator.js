...
if (age < 10) {
  ...
  const payAmount = regularPrice - discountPrice;
  console.log("As you are a senior citizen, you will pay",payAmount,"Taka!");
}
else {
    console.log("Regular ticker fare is",regularPrice,"Taka!");
}